...
int main()
{
    ...
    // shader
    Shader cubeShader("./src/lights/basicLight/cube.vs", "./src/lights/basicLight/cube.fs");
    Shader lightCubeShader("./src/lights/basicLight/lightCube.vs", "./src/lights/basicLight/lightCube.fs");
