...
int main()
{
    ...
    // shader
    Shader cubeShader("./src/lights/materials/cube.vs", "./src/lights/materials/cube.fs");
    Shader lightCubeShader("./src/lights/materials/lightCube.vs", "./src/lights/materials/lightCube.fs");
