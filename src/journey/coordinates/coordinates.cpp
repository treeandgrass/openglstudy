...
int main(int argc, char** argv) {
    ...
    Shader shader("src/journey/coordinates/vertexShader.txt", "src/journey/coordinates/fragmentShader.txt");
    ...
    data = stbi_load(FileSystem::getPath("resources/textures/awesomeface.png").c_str(), &width, &height, &channels, 0);
    if (data)
    {
